...
3. **Open the notebook** (`claude-api.ipynb`) in Jupyter or VS Code and run the cells.

## Note on models

The notebook uses `claude-sonnet-4-0`, which the SDK flags as deprecated (EOL June 15, 2026). To keep these examples working, migrate to a current model such as `claude-sonnet-4-6` or `claude-opus-4-8`.
